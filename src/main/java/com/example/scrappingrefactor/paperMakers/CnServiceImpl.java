...
public final class CnServiceImpl extends paperMakerImpl implements PaperMakerService {
    private final String pmCode = "CN";

    public CnServiceImpl(Environment env) {
        super(env);
    }
