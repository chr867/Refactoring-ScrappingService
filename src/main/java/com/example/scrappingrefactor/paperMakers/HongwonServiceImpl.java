...
public final class HongwonServiceImpl extends paperMakerImpl implements PaperMakerService {
    private final String pmCode = "HW";

    public HongwonServiceImpl(Environment env) {
        super(env);
    }
