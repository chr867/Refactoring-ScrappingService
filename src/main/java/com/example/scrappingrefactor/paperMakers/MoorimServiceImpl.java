...
public final class MoorimServiceImpl extends paperMakerImpl implements PaperMakerService {
    private final String pmCode = "MR";

    public MoorimServiceImpl(Environment env) {
        super(env);
    }
